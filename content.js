var slideshows = {
  programming: {
    ...
    content: [
      ...
      <div class="projectsButton nxt" onclick="slideshowNext('programming');">Next Project</div>`,
    ...
    originalContent: "",
    simpleContent: `I've been programming since I was eight, starting with <a href="http://scratch.mit.edu">Scratch</a> in primary school before swiftly moving on to Python.
    Now, alongside Python, I'm experienced in JavaScript and C#. Here are some of my favourite projects.`
  },
  music: {
    count: -1,
    content: [
      ...
      <br><div class="projectsButton nxt" onclick="slideshowNext('music');">Next Project</div>`,
    ...
    originalContent: "",
    simpleContent: `I've played the piano since I was just four, and I composed my first piece at six.
    Since then, I reached Grade 5 before quitting grades in favour of focusing on my composition skills.
    Alongside my work for GCSE Music, I've arranged numerous pieces for both my peers and my family to play across a wide range of genres.
    Here are some of my favourite musical projects!`
  },
  video_editing: {
    count: -1,
    content: [
      ...
      <div class="projectsButton nxt" onclick="slideshowNext('video_editing');">Next Project</div>`,
    ...
    originalContent: "",
    simpleContent: `As well as showing my creativity through music, I also have quite a lot of experience in video editing.
    I've been editing since I was around nine, and I've used <a href="https://fxhome.com/hitfilm-express/specs">professional software</a> since thirteen.
    I'm able to edit in a variety of genres, as you'll see when you look below and browse my video projects.`
  }
};
